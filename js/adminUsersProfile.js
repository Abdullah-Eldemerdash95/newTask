...
const adminContainerPara = document.querySelector(".admin-container p");
const adminContainerImg = document.querySelector(".admin-container img");
const logout = document.getElementById("logout");
const contentContainer = document.getElementById("contentContainer");

adminContainer.setAttribute("id", localStorage.getItem("id"))
adminContainerPara.textContent = "Hello " + localStorage.getItem('firstName'); 
adminContainerImg.setAttribute("src", localStorage.getItem('avatar'));
...
()=> {// getting admin users to dispaly
    ...
    { // this for page 2 users the employees
        const get3 = {
            method: "get",
            headers : { "content-type" : "application/json; charset=UTF-8" },
            };
